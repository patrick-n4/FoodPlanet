...
export default function AddClient() {
  ...
  return (
    <form onSubmit={handleforms} className="flex flex-col  w-[50%] h-[100%]">
      <h1 className="client text-orange-400 ml-[50rem] mt-[5rem] text-4xl">
        Client
      </h1>
      <div className="client-content ml-[40rem] mt-[5rem]">
        ...
        <input
          type="text"
          className="client-input text-400xl border-b-2 border-solid py-2 w-[30rem] none mt-4"
      ...
      <div className="client-content ml-[40rem] mt-[5rem]">
        ...
        <input
          type="text"
          className="client-input text-400xl border-b-2 border-solid py-2 w-[30rem] none mt-4"
          placeholder="Province,District and sector"
        />
      </div>
      <div className="client-content ml-[40rem] mt-[5rem]">
      ...
      <div className="client-content ml-[40rem] mt-[5rem]">
        ...
        <input
          type="text"
          className="client-input none text-400xl border-b-2 border-solid py-2 w-[30rem]  mt-4"
          placeholder="Account number"
        />
      </div>
      <button
        type="submit"
        className="btn bg-[orange] cursor-pointer hover:bg-orange-400 p-4 w-48 ml-[50rem] text-white text-2xl rounded-[5px] my-8"
      >
        Add client
      </button>
    </form>
